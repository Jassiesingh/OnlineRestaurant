...
<body style="background-color: #282828; margin: 0; padding: 0; box-sizing: border-box; color: white;">
    <div>
        ...
        <div class="container my-5" style="background-color:white; position:-webkit-sticky; position:sticky; top:0; z-index:2; height:245px;">
            <div class="row">
                <div class="col-sm-4">
                    <img class="display: d-flex-auto  my-2 img-fluid" data-src="holder.js/350x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 254px; height: 165px; padding-top: 5;" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/nzjjiyvtw67a5drs0gdx" data-holder-rendered="true">
                </div>

                <div class="col-md-4 my-3" style="align-items: right;">
                    <h2><span style="color: black;">Jassie Da Dhaba  <img style="height: 20px; width: 20px;" src="https://www.pngkey.com/png/detail/261-2619381_chitr-veg-symbol-svg-veg-and-non-veg.png" alt=""></span></h2>
                </div>
            </div>
        </div>
        ...
        <div class="row mx-5">
            <div class="col-md-7">
                <div class="container" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">
                    ...
                    $query = 'SELECT * FROM jassiedhaba ORDER by id ASC';
                    ...
                    ?>
                                <div class="container">
                                    ...
                                    <div class="col-sm-3 col-md-3">
                                        <form method="post" action="menu1.php?action=add&id=<?php echo $dishname['id']; ?>">
                                            <div class="product">
            ...
            <form method="post" action="ordersubmit.php?add">
                <div class="table-responsive" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">
                    <table class="table">
                        ...
                        <tr>
                            <th width="40%" style="color: white;">Product Name</th>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="menu1.php?action=delete&id=<?php echo $dishname['id']; ?>">
    ...
    <!--<div style="background-color: #d4d4d3; color: black;">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <div class="s-FIt" style="text-align: center;">Address</div>
                        <div class="_1H27p">
                            <hr class="featurette-divider my-3" style="background-color: black; border-bottom:  solid #bbb;">
                        </div>
                        <div class="_396MD my-5">Chawla Fast Food, Building No 20, Near Hari Mandir, Sion</div>
                    </div>

                    <div class="col-md-5 mx-5" style="text-align: center;">
                        <div class="s-FIt">Cuisines</div>
                        <div class="_1H27p">
                            <hr class="featurette-divider my-3" style="background-color: black; border-bottom:  solid #bbb;">
                        </div>
                        <div class="_396MD my-5">Fast Food</div>
                    </div>
                </div>
            </div>
        </div>-->
